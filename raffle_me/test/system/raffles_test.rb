...
class RafflesTest < ApplicationSystemTestCase
  ...
  test "creating a Raffle" do
    ...
    fill_in "Entriespool", with: @raffle.entriesPool
    fill_in "Joincode", with: @raffle.joinCode
    fill_in "Owner", with: @raffle.owner
    fill_in "Questionpool", with: @raffle.questionPool
