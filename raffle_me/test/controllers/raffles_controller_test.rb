...
class RafflesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create raffle" do
    assert_difference('Raffle.count') do
      post raffles_url, params: { raffle: { entriesPool: @raffle.entriesPool, joinCode: @raffle.joinCode, owner: @raffle.owner, questionPool: @raffle.questionPool } }
    end
  ...
  test "should update raffle" do
    patch raffle_url(@raffle), params: { raffle: { entriesPool: @raffle.entriesPool, joinCode: @raffle.joinCode, owner: @raffle.owner, questionPool: @raffle.questionPool } }
